...
public class FileAdapter extends BaseAdapter {
	...
	public FileAdapter(Context context, List<FileInfo> fileInfoList, int item) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		info_center_command.setText(fileInfo.getSubject());
		info_center_content.setText(fileInfo.getContent());
		info_center_receive_date.setText(parseSendTime(fileInfo.getSendTime()));
