...
public class NotificationAdapter extends BaseAdapter {
	...
	public NotificationAdapter(Context context,
			List<NotificationInfo> notifiInfoList, int item) {
	...
	public int getCount() {
		...
		return notifiInfoList.size();
	}

	@Override
	public Object getItem(int position) {
		// TODO Auto-generated method stub
		return notifiInfoList.get(position);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		NotificationInfo notifiInfo = notifiInfoList.get(position);
		info_center_command.setText(EMMContants.MsgType.NOTIFICATION);
		info_center_content.setText(notifiInfo.getContent());
		info_center_receive_date.setText(parseSendTime(notifiInfo.getSendTime()));
